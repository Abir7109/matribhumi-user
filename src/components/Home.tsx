...
export default function Home({ onPackageSelect, onStepSelect, onAlbumOpenChange }: HomeProps) {
  ...
  return (
    <div>
      ...
      {/* Packages */}
      <section id="packages" className="pt-10 md:pt-32 pb-12 px-4 max-w-7xl mx-auto">
